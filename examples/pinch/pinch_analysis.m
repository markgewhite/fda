...
pinchbasis = create_bspline_basis([0,0.25], 153, 4); % previously 0.25, 153
pinchfdPar = fdPar(pinchbasis, 2, 1e-6); 

%  -----------  create fd object (no smoothing)  --------------------

pinchfd = smooth_basis(time, force, pinchfdPar);
...
%plotfit_fd(force, time, pinchfd, casenames, varnames, ...
%           residual, sortwrd)
